...
[![Release version](https://img.shields.io/github/release/clovadev/TCP-communication.svg?style=popout-square)](https://github.com/clovadev/TCP-communication/releases/latest) ![Download count](https://img.shields.io/github/downloads/clovadevx/TCP-communication/total.svg?style=popout-square) ![License](https://img.shields.io/github/license/clovadev/TCP-communication.svg?style=popout-square) 
...
![how_to_use](https://github.com/clovadev/TCP-communication/blob/master/imgs/How_to_use.gif)
